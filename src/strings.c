...
const u8 gText_PokeSum_EggOrigin_DayCare[] = _("An odd POKéMON EGG\nfound by the DAY-CARE couple.");
const u8 gText_PokeSum_EggOrigin_TravelingMan[] = _("An odd POKéMON EGG\nobtained from the\ntraveling man.");
const u8 gText_PokeSum_EggOrigin_NicePlace[] = _("A wondrously peculiar\nPOKéMON EGG obtained\nat a nice place.");
const u8 gText_PokeSum_EggOrigin_Spa[] = _("An odd POKéMON EGG\nobtained from an old\nwoman at the SPA.");
