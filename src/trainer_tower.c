...
static const u16 sTrainerTowerEncounterMusic[] = {
    [TRAINER_ENCOUNTER_MUSIC_MALE]        = MUS_HG_ENCOUNTER_BOY_1,
    [TRAINER_ENCOUNTER_MUSIC_FEMALE]      = MUS_HG_ENCOUNTER_GIRL_2,
    [TRAINER_ENCOUNTER_MUSIC_GIRL]        = MUS_HG_ENCOUNTER_GIRL_1,
    [TRAINER_ENCOUNTER_MUSIC_SUSPICIOUS]  = MUS_HG_ENCOUNTER_SUSPICIOUS_1,
    [TRAINER_ENCOUNTER_MUSIC_INTENSE]     = MUS_HG_ENCOUNTER_SAGE,
    [TRAINER_ENCOUNTER_MUSIC_COOL]        = MUS_HG_ENCOUNTER_BOY_2,
    [TRAINER_ENCOUNTER_MUSIC_AQUA]        = MUS_HG_ENCOUNTER_ROCKET,
    [TRAINER_ENCOUNTER_MUSIC_MAGMA]       = MUS_HG_ENCOUNTER_ROCKET,
    [TRAINER_ENCOUNTER_MUSIC_SWIMMER]     = MUS_HG_ENCOUNTER_BOY_1,
    [TRAINER_ENCOUNTER_MUSIC_TWINS]       = MUS_HG_ENCOUNTER_GIRL_1,
    [TRAINER_ENCOUNTER_MUSIC_ELITE_FOUR]  = MUS_HG_ENCOUNTER_KIMONO_GIRL,
    [TRAINER_ENCOUNTER_MUSIC_HIKER]       = MUS_HG_ENCOUNTER_SUSPICIOUS_2,
    [TRAINER_ENCOUNTER_MUSIC_INTERVIEWER] = MUS_HG_ENCOUNTER_KIMONO_GIRL,
    [TRAINER_ENCOUNTER_MUSIC_RICH]        = MUS_HG_ENCOUNTER_BOY_2
};
