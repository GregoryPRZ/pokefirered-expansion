...
EWRAM_DATA u32 sRfuAPIBuffer[RFU_API_BUFF_SIZE_RAM / 4] = {}; // static u32 sRfuAPIBuffer[RFU_API_BUFF_SIZE_RAM / 4];
...
EWRAM_DATA struct RfuManager gRfu = {}; // COMMON_DATA struct RfuManager gRfu = {0};
